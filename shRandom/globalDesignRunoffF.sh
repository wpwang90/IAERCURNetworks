...
CROFDIR="/home/woqie/Documents/designData/ChinaPro/GuangxiRandom/"      #   runoff directory
CROFPRE="wRoffGuangxiUniformF"                         #   runoff prefix/suffix  ( $(PREFIX)yyyymmdd$(SUFFIX) )
CROFSUF=".one"
