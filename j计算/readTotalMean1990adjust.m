clear;clc
binfilename='G:\\testRunoff\\runtestResult\\flddph1990.bin';
first=datenum(1989, 12, 31);
totalData=zeros(1440,720);
totalI={};
first=first+1;
file_name=['G:\1990-sp1\temp\flddph1990adjust.ctl'];
...
geotiffwrite('G:\1990-sp1\flddph1990adjustmean.tif',tData'/365,R);