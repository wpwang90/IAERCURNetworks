clear;clc
Files = dir(fullfile('D:\testRunoff\MIROCESM\RCP26result_1','flddph*.bin'));
LengthFiles = length(Files);
Data={};
nyear=1989;
for jF = 1:LengthFiles
binfilename=['D:\testRunoff\MIROCESM\RCP26result_1\', Files(jF).name];
